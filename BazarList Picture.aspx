<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BazarList Picture.aspx.cs" Inherits="BazarList_Picture" %>
        ...
        <div class="container">
		                ...
		                <div class="container-fluid">
			                ...
			                <div class="collapse navbar-collapse custom_nav" id="bs-example-navbar-collapse-1">
			                    <ul class="nav navbar-nav navbar-right">
                                   ...
                                   <li class="active"><a href="BazarList Picture.aspx">BazarList</a> </li>
                                   <li>
            ...
            &nbsp;
             <br />
                                    ...
                                    <asp:DataList ID="dListImages"  runat="server" RepeatColumns="3">
                                        <ItemTemplate>
                                            <table border="1">
                                                <tr>
                                                    <td>
                                                        <img alt='<%#Eval("Listpicture") %>' src='<%#Eval("Listpicture") %>' class="imgt" /></td>
                                                </tr>
                                            </table>
                                        </ItemTemplate>
                                    </asp:DataList>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mealManagement %>" SelectCommand="SELECT Listpicture FROM finalPage"></asp:SqlDataSource>
